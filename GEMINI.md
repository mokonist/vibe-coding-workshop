...
- **`docs/*.md`** 作成するべきシステムの定義を記載した「仕様書」です。ユーザーの指示がある docs/*.md を使用して実装を進めます。ただし、 docs/*.md の明示的な指定が無い場合、  **PRD_TEMPLATE.md** に従って、仕様を作成してから実装を進めてください。
...
- サーバーの実行はnpm run devで可能です。ポートは3001 になっている点注意してください。
